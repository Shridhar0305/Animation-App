...
//  Animated
//
//  Created by Shridhar Vashishtha on 6/5/23.
//
...
struct OnboardingView: View {
    ...
    var content: some View{
        VStack(alignment: .leading, spacing: 16){
            ...
            Text("Purchase includes access to 30+ courses, 240+ premium tutorials, 120+ hours of videos, source files and certifications.")
                .customFont(.footnote)
                .opacity(0.7)
        }
        .padding(40)
